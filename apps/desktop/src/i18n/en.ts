...
export const en: Translations = {
  ...
  boot: {
    ready: 'Multitasker Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Multitasker settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Multitasker Desktop…'
    },
    errors: {
      backgroundExited: 'Multitasker background process exited.',
      backgroundExitedDuringStartup: 'Multitasker background process exited during startup.',
    ...
    failure: {
      title: "Multitasker couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Multitasker backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Multitasker',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Multitasker Desktop.',
    ...
    native: {
      ...
      inputBody: 'Multitasker is waiting for your response.',
      turnDoneTitle: 'Multitasker finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Multitasker defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Multitasker is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Multitasker asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Multitasker was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    searchPlaceholder: {
      about: 'About Multitasker Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Multitasker follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Multitasker checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Multitasker configuration...',
    ...
    gateway: {
      ...
      intro:
        'Multitasker Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Multitasker backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Multitasker backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Multitasker backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Multitasker Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Multitasker ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Multitasker runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      connectAnother: 'Connect another provider',
      otherProviders: 'Other providers',
      removeConfirm: provider => `Remove ${provider}?`,
      removeExternal: (provider, command) => `${provider} is managed outside Multitasker. Remove it with ${command}.`,
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Multitasker desktop' },
    ...
    hermesActiveSessions: (version, count) => `Multitasker ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Multitasker environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Multitasker will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Multitasker...',
    placeholderReconnecting: 'Reconnecting to Multitasker…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Multitasker a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Multitasker will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      restart: 'Restarting Multitasker…',
    ...
    unsupportedMessage: 'This version of Multitasker can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Multitasker is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Multitasker backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Multitasker from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Multitasker will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Multitasker updater will take over in its own window and reopen Multitasker when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Multitasker reconnects automatically when it’s back.',
    applyingClose: 'Multitasker will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Multitasker needs a one-time install',
    ...
    settingUpTitle: 'Setting up Multitasker Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Multitasker CLI or desktop instance is running. Stop any running Multitasker instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Multitasker installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Multitasker Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Multitasker is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Multitasker…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Multitasker',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Multitasker at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Multitasker connects automatically',
      loopback: 'Opens your browser to sign in — Multitasker connects automatically',
    ...
    authorizeThere: 'Authorize Multitasker there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Multitasker there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Multitasker inference gateway status',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Multitasker will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Multitasker is restarting...',
      askRestart: 'Ask Multitasker to restart the server',
      lookingRestart: taskId => `Multitasker is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Multitasker is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Multitasker finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Multitasker could not restart the server.',
      stillWorking:
        'Multitasker is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Multitasker is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Multitasker gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Multitasker won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Multitasker needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Multitasker needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Multitasker Desktop to use Save Image.',
    restartToSaveImages: 'Restart Multitasker Desktop to save images',
